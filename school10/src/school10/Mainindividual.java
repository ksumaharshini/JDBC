...
public class Mainindividual {
    private static final String URL = "jdbc:mysql://localhost:3306/school10";
    private static final String USER = "root";
    private static final String PASSWORD = "rohith2122";
    ...
    private static void retrieveMarkRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String retrieveStudentDetails = "SELECT * FROM school10table3 WHERE name=?";
    ...
    public static class StudentDetails {
        ...
        public static void studentTable(Statement stmt) throws SQLException {
            String studentTable = "CREATE TABLE IF NOT EXISTS school10table1 " +
    ...
    public static class MarksDetails {
        ...
        public static void marksTable(Statement stmt) throws SQLException {
            String marksTable = "CREATE TABLE IF NOT EXISTS school10table3 " +
                    "(name VARCHAR(255), " +
                    "english INT, " +
                    "mathematics INT, " +
                    "science INT, " +
    ...
    private static void createRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String insertStudentDetails = "INSERT INTO school10table1 VALUES (?, ?, ?, ?, ?)";
        ...
        String insertStudentMarks = "INSERT INTO school10table3 VALUES (?, ?, ?, ?, ?)";
    ...
    private static void readRecords(Statement stmt) throws SQLException {
        ...
        ResultSet resultSet = stmt.executeQuery("SELECT * FROM school10table1");
    ...
    private static void updateRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        System.out.print("Date of Birth (YYYY-MM-DD): ");
        String dob = scanner.next();
        String updateStudentDetails = "UPDATE school10table1 SET name=?, class=?, section=?, dob=? WHERE redgno=?";
    ...
    private static void deleteRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        int regNo = scanner.nextInt();
        String deleteStudentDetails = "DELETE FROM school10table1 WHERE redgno=?";
